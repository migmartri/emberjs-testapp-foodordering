...
This is just a simple app with the sole purpose of learning emberjs along with a Ruby on Rails backend.
...
I know that the code here probably stinks but well, it is my first ember app and I'll be happy to know the ember way to do things :)
...
Let's just learn ember using this playground!
